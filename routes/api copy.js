...
router.post('/update-payment-all',function(req,res,next){
  var optin = require('../controller/TransactionController');
  optin.updatepaymentall(req,res,next);
});

router.post('/crawl-data',function(req,res,next){
  var cr = require('../controller/TestDataEntry');
  cr.testdata(req,res,next);
});

router.post('/get-crawl-data',function(req,res,next){
  var cr = require('../controller/TestDataEntry');
  cr.gettestdata(req,res,next);
});


router.get('/crawl-count',function(req,res,next){
  var cr = require('../controller/TestDataEntry');
  cr.gettestdatacount(req,res,next);
});
